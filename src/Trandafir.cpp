...
Trandafir::Trandafir(std::string denumire_, const int numar_boboci_, const int durata_viata_, const int zi_plantare_, const int numar_spini_) : Floare(denumire_, numar_boboci_, durata_viata_, zi_plantare_), numar_spini{numar_spini_} {}
...
{
    os << "Trandafirul este o floare eleganta si parfumata, cunoscuta pentru petalele sale delicate si colorate. Este un simbol al iubirii si frumusetii.\n";
}
